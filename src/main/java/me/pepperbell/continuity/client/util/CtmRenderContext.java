 ...
 * 
 * This allows BlockModelPart.getQuads() to access world context during rendering,
 * even though BlockStateModel.addParts() doesn't have access to it at bake time.
 * 
...
public class CtmRenderContext {
	 ...
	 * Called by BlockModelRendererMixin at the start of render().
	 */
	...
	/**
	 * Get the current rendering context, or null if not currently rendering.
	 * Called by CtmBlockModelPart.getQuads() to access world context.
	 * 
	 ...
	 * Called by BlockModelRendererMixin at the end of render().
	 */
